...
class UpdateCheck extends JFrame implements ActionListener{
    ...
    public UpdateCheck() {
        ...
        JLabel lblNewLabel_3 = new JLabel("Checked-in-time :");
        ...
        txt_Amount.setBounds(248, 258, 140, 20);
        ...
        btnUpdate.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                try {
                    ...
                    String s5 = txt_Amount.getText(); //txt_Amount    

                    c.s.executeUpdate("update customer set number = '" + s2 + "', name = '" + s3 + "', checkintime = '" + s4 + "', deposit = '" + s5 + "' where number = '" + s1 + "'");
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    while (rs1.next()) {
                        ...
                        txt_Amount.setText(rs1.getString("deposit"));
                    }
                } catch (Exception ee) {
                }
                ...
                try {
                    ...
                    String paid = txt_Amount.getText();
