...
class NewCustomer extends JFrame{
    ...
    public NewCustomer()  { 
		...
		contentPane.add(lblReserveRoomNumber);
                ...
                try{
                    Conn c = new Conn();
                    ResultSet rs = c.s.executeQuery("select * from room");//used to get the values from db
                    while(rs.next()){
                        c1.add(rs.getString("roomnumber"));   // using column name
                    }
                }catch(Exception e){ }
        ...
        AddCustomer.setBounds(100, 430, 120, 30);
